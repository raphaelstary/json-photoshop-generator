...
var LayerParser = (function (Vectors, StringUtils, rgbToHex, Layer, Tagger, Math) {
    ...
    LayerParser.prototype.parseShape = function (layer) {
        ...
        if (layer.path.pathComponents[0].origin.type == 'line') {
            ...
            type = 'rectangle';
        } else if (layer.path.pathComponents[0].origin.type == 'ellipse') {
            type = 'circle';
        }
        ...
        if (type == 'line') {
            ...
            drawable.radius = Math.floor(drawable.width / 2);
        }
        ...
        if (layer.strokeStyle) {
            ...
            if (layer.strokeStyle.strokeEnabled)
                drawable.lineWidth = layer.strokeStyle.strokeStyleLineWidth;
            if (layer.strokeStyle.strokeStyleLineDashSet)
                drawable.lineDash = layer.strokeStyle.strokeStyleLineDashSet;
        }
